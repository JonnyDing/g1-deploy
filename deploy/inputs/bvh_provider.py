...
from deploy.retargeting.gmr.utils.lafan_vendor.extract import read_bvh
...
def _load_bvh_file(bvh_file: str, format: str = "lafan1"):
    ...
    rotation_quat = matrix_to_quat_np(rotation_matrix, scalar_first=True)
